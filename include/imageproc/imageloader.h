...
namespace imgproc
{
	...
	public:
		...
		void rotate(double rotRadians, int channels = 1, bool releaseFlag = true, int maxWidth = -1, int maxHeight = -1);
	...
	int encodeWH(int width, int height, int posOffset = 100000);
	void decodeWH(int& width, int& height, int code, int posOffset = 100000);
}
